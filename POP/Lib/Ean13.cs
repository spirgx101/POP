...
namespace POP.Lib
{
    public class Ean13
    {
        ...
        private float _fFontSize = 10.0f;
        ...
        public void DrawEan13Barcode(System.Drawing.Graphics g, System.Drawing.Point pt, float codeHeight = 0)
        {
            ...
            if (codeHeight == 0)
                ...
                height = codeHeight * this.Scale * 0.254f;
            ...
            float xStart = pt.X * 0.254f;   // 0.255為條碼位置調整
            float yStart = pt.Y * 0.254f; 
            float xEnd = 0;
            xPosition = xStart;
            ...
            xPosition = xStart - g.MeasureString(this.CountryCode.Substring(0, 1), font).Width * 0.01f;  // 0.01f為微調數字
            ...
            xPosition += (g.MeasureString(sTemp.Substring(0, 1), font).Width + 44 * lineWidth) -
            ...
            xPosition += g.MeasureString(sTemp.Substring(1, 6), font).Width + (6 * lineWidth);
